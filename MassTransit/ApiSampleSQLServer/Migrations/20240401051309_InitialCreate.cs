...
namespace ApiSampleSQLServer.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    doc_entry_ov = table.Column<int>(type: "int", nullable: true),
                    doc_entry_invoice = table.Column<int>(type: "int", nullable: true),
                    doc_entry_payment = table.Column<int>(type: "int", nullable: true),
                    registration_id = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    doc_entry_ov_expiration_date = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_payment_state", x => x.correlation_id);
                });
